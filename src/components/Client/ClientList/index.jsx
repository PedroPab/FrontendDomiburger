...
import CardCreateClient from '../../CardCreate/CardCreateClient';
  ...
  return (
    <>
      <Row className="g-3 mt-4 mb-4">
        ...
        <Col xs={12} sm={6} lg={4}>
          <CardCreateClient handleCardClick={handleCardCreateClientClick} messageText='Crear un nuevo cliente' />
        </Col>
        {clients.length === 0 ? (
